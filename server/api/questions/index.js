...
router.get(`${baseUrl}/:qId`, function (req, res) {
...
router.put(`${baseUrl}/:qId/answers/:aId`, function (req, res, next) {
...
router.delete(`${baseUrl}/:qId/answers/:aId`, function (req, res, next) {
	req.answer.remove()
		.then(function () {
